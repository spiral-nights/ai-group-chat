defmodule AiGroupChatWeb.Router do
  use AiGroupChatWeb, :router

  import AiGroupChatWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {AiGroupChatWeb.Layouts, :root}
  ...
  # scope "/api", AiGroupChatWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:ai_group_chat, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: AiGroupChatWeb.Telemetry
  ...
  scope "/", AiGroupChatWeb do
    ...
    live_session :current_user,
      on_mount: [{AiGroupChatWeb.UserAuth, :mount_current_user}] do
